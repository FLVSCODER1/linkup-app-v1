    ...
    <main className="min-h-screen bg-transparent px-4 py-6 pb-28 text-white sm:px-6 lg:px-10 lg:py-9">
      ...
      <section className="mx-auto max-w-lg">
        ...
        {message || !profile ? (
          ...
          <article className="rounded-3xl border border-white/10 bg-white/[0.045] p-6 shadow-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#8f8aff]">
